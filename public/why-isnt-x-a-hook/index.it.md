...
**Un primo sguardo ai valori intermedi ci dice quale Hook al livello più alto contiene il bug**. Non abbiamo bisogno di guardare all'interno di _tutti_ gli Hook.
